...
list <- c('A2A.MI','ATL.MI','AZM.MI','BGN.MI','BMED.MI',
...
#list of 40 stocks
list_names <- c('A2A','Atlantia','Azimut','Banca Generali','Banca Mediolanum',
                ...
                'Poste Italiane','Prysmian','Recordati','Saipem','Salvatore Ferragamo',
